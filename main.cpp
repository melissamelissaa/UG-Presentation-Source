...
// მოიფიქრეთ კლასები რომლებიც გამოყენებული იქნება უნივერსიტეტის,
// სტუდენტის, კურსების აღსაწერად.
// გამოიყენეთ მემკვიდრეობითობის თვისება და შემოიტანეთ სხვადასხვა
// ფაკულტეტის/სკოლის სტუდენტების კლასები, რომლბიც მემკვიდრეობით იქნება მიღებული კლასო - სტუდენტისაგან.
// განსაზღვრეთ სტატიკური ველები და სტატიკური ფუნქციები, რომლებიც მიეკუთვნებიან სტუდენტისა და უნივერსიტეტის კლასებს.

// მოიყვანეთ პოლიმორფიზმის მაგალითები და აღწერეთ სტუდენტების კლასში ერთიდაიგივე სახელის მქონე ფუნქციები,
// სხვადასხვა არგუმენტებით. მოიყვანეთ კლასის კონსტრუქტორების მაგალითები. მოიყვანეთ აბსტრაქტული კლასებისა და
// ვირტუალური ფუნქციების მაგალითები. შექმენით სტუდენტების კლასისს ობიექტების მასივები.
